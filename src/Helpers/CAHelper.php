...
class CAHelper
{
    ...
    public static function print_menu_editor($menu)
    {
        ...
        $childrens = \Kipl\Crmadmin\Models\Menu::where("parent", $menu->id)->orderBy('hierarchy', 'asc')->get();
    ...
    public static function print_menu($menu, $active = false)
    {
        ...
        $str = '<li' . $treeview . ' ' . $active_str . '><a href="' . url(config("crmadmin.adminRoute") . '/' . $menu->url) . '"><i class="fa ' . $menu->icon . '"></i> <span>' . CAHelper::real_module_name($menu->name) . '</span> ' . $subviewSign . '</a>';
    ...
    public static function print_menu_topnav($menu, $active = false)
    {
        ...
        $str = '<li ' . $treeview . '' . $active_str . '><a ' . $treeview2 . ' href="' . url(config("crmadmin.adminRoute") . '/' . $menu->url) . '">' . CAHelper::real_module_name($menu->name) . $subviewSign . '</a>';
     ...
     *
     * CAHelper::get_migration_file("students_table");
     *
